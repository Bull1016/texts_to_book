...
<div class="min-h-screen flex items-center justify-center bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
    <div class="max-w-md w-full bg-white rounded-lg shadow p-8">
        <h2 class="text-xl font-bold text-center text-gray-900 mb-6">Confirm Password</h2>

        <p class="text-gray-600 mb-6">For your security, please confirm your password before continuing.</p>
